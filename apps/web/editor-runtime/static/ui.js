(function ( w, d, PKAE ) {
...

					{
						...
						setup: function ( obj ) {
							...
							app.listenFor ('DidStoreDB', function ( obj, e ) {
									...
									var storedTitle = 'Successfully Stored';
									var openInNew = 'OPEN IN NEW WINDOW';
									var askBody = '<p>Open in new window?</p>';
                                    new PKSimpleModal ({
                                        title : storedTitle,
							...
							app.listenFor ('LoadDraft', function ( name, append ) {
									app.fls.Init (function (err) {
										...
										if (app.engine.is_ready && !append)
										{
                                            ...
                                            (function() {
												var openTitle = 'Open in Existing?';
												var openBody  = '<div>Open in new window, or in the current one?</div>';
												var openBtnExisting = 'OPEN';
												var openBtnNew = 'OPEN IN NEW';
	...
	function _makeUIMainView ( UI, app ) {
        ...
        var dragText = 'Drag n drop an Audio File in this window, or click ';
        var hereText = 'here to use a sample';
	...
	function _makeUIToolbar (UI) {
        ...
        var selClearText = 'Clear Selection (Q key)';
